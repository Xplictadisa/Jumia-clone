import { rowTwentyFiveData } from "../_data/rowTwentyFive";
...
function RowTwentyFive() {
  const data: data[] = rowTwentyFiveData;

  return (
    <div className="px-11 mt-5">
      <div className="rounded-[5px] w-full shadow-btnShadow bg-white pb-2">
        <Title title="Shop Makeup below ₦ 1,000" link="www.facebook.com" />
        {/*  */}
